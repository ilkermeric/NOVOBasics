...
plt.figure()
bins = np.arange(0.1, IncidentPhotonEnergy, 0.01)
...
plt.title( str(IncidentPhotonEnergy) + " MeV photons w/o segmentation")
plt.xlabel("Energy[MeV]")
plt.ylabel("Entries")
plt.yscale("log")
plt.legend()

plt.savefig('OriginalREEnergyDistribution.png', dpi=250, bbox_inches='tight')
